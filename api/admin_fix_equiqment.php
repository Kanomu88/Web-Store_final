        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="widgets.html"> <i class="menu-icon fa fa-id-card-o"></i>รายชื่อผู้ยืม</a>
                    </li>
                    <li>
                        <a href="widgets.html"> <i class="menu-icon fa fa-cogs"></i>อุปกรณ์ทั้งหมด</a>
                    </li>
                    <li>
                        <a href="widgets.html"> <i class="menu-icon fa fa-tasks"></i>ประวัติการยืม</a>
                    </li>
