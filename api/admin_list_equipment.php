                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">ตารางแสดงอุปกรณ์ทั้งหมด</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data" class="table table-striped table-bordered">
                                    ...
                                    <?php
                                        ...
                                        $firebaseAppURL = $firebaseDatabaseURL . 'products.json?auth=' . $firebaseSecretKey;
                                        ...
                                        if (!empty($firebaseData)) {
                                            foreach ($firebaseData as $products) {
                                                echo "<tr>";
...
const databaseRef = ref(database, 'products/' +'products/' );
...
$(document).ready(function() {
        ...
        onValue(databaseRef, snapshot => {
            snapshot.forEach(function(childSnapshot) {
                ...
                var productName = childData.name;
                var quantity = childData.quantity;
                var imageURL = childData.imageURL;
                table.row.add([productName, quantity, '<img src="' + imageURL + '" width="100" height="100">']).draw();
            });
        });
    });
  </script>
